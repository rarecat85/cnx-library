    ...
    <div class="guide-content">
      ...
      <nav class="toc">
        ...
        <ul>
          ...
          <li><a href="#location">라벨번호와 위치 안내</a></li>
      ...
      <section id="intro" class="guide-section">
        ...
        <div class="section-content">
          ...
          <div class="info-box">
            <h4>📱 사이드 메뉴 안내</h4>
            <p>우측 상단의 햄버거 메뉴(☰)를 클릭하면 사이드 네비게이션이 열립니다.</p>
            <ul>
              <li>메뉴 하단에서 <strong>이용가이드</strong>, <strong>문의하기</strong>, <strong>로그아웃</strong> 기능에 빠르게 접근할 수 있습니다.</li>
              <li>문의사항은 <strong>officemanager.korea@concentrix.com</strong>으로 연락해주세요.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="auth" class="guide-section">
        ...
        <div class="section-content">
          ...
          <div class="info-box highlight">
            ...
            <p class="small-note">※ 자동로그인 기능은 보안상의 이유로 제공되지 않습니다.</p>
          </div>
        </div>
      </section>
        ...
        <div class="section-content">
          ...
          <ol class="step-list">
            <li>
              <span class="step-number">1</span>
              <div class="step-content">
                <strong>메뉴에서 "도서 대여" 선택</strong>
                <p>좌측 햄버거 메뉴를 열고 "도서 대여"를 클릭합니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">2</span>
            ...
            <li>
              ...
              <div class="step-content">
                <strong>도서 검색</strong>
                <p>검색창에 도서명 또는 ISBN-13을 입력하여 검색할 수 있습니다.</p>
              </div>
            </li>
          </ol>
          ...
          <div class="info-box highlight">
            <h4>📍 동일 도서 여러 권</h4>
            <p>같은 책이 여러 권 등록된 경우, 도서 카드에 총 권수와 대여 가능 권수가 표시됩니다.</p>
            <p>대여 시 라벨번호별로 원하는 권을 선택할 수 있습니다.</p>
          </div>
        </div>
      </section>
        ...
        <div class="section-content">
          ...
          <ol class="step-list">
            ...
            <li>
              <span class="step-number">2</span>
              <div class="step-content">
                <strong>라벨번호 선택 (여러 권일 경우)</strong>
                <p>같은 책이 여러 권인 경우, 원하는 라벨번호를 선택합니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">3</span>
              <div class="step-content">
                <strong>대여 확인</strong>
                <p>도서 정보, 라벨번호, 위치를 확인한 후 "대여하기"를 클릭합니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">4</span>
              <div class="step-content">
                <strong>도서 수령</strong>
                <p>확인한 위치에서 해당 라벨번호의 도서를 가져갑니다.</p>
              </div>
            </li>
          </ol>
          ...
          <ol class="step-list">
            <li>
              <span class="step-number">1</span>
              <div class="step-content">
                <strong>도서 카드 클릭하여 선택</strong>
                <p>대여할 도서 카드를 클릭하면 선택됩니다 (파란색 테두리).</p>
              </div>
            </li>
            <li>
              <span class="step-number">2</span>
              <div class="step-content">
                <strong>여러 권 선택 후 "대여 신청"</strong>
                <p>원하는 도서를 모두 선택한 후 하단의 "대여 신청" 버튼을 클릭합니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">3</span>
              <div class="step-content">
                <strong>대여 확인</strong>
                <p>선택한 모든 도서의 정보와 위치를 확인한 후 대여합니다.</p>
              </div>
            </li>
          </ol>
          ...
          <ol class="step-list">
            ...
            <li>
              <span class="step-number">4</span>
              <div class="step-content">
                <strong>도서 반납 위치 확인</strong>
                <p>반납 확인 다이얼로그에서 라벨번호와 위치를 확인하고, 해당 위치에 도서를 반납합니다.</p>
              </div>
            </li>
          </ol>
          ...
          <h3>반납 알림 신청</h3>
          <p>대여하고 싶은 도서가 모두 대여 중일 때, 반납 알림을 신청할 수 있습니다.</p>
          <ol class="step-list">
            <li>
              <span class="step-number">1</span>
              <div class="step-content">
                <strong>대여중인 도서 확인</strong>
                <p>도서 목록에서 "대여중인 도서입니다." 메시지가 표시된 도서를 찾습니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">2</span>
              <div class="step-content">
                <strong>"반납알림받기" 클릭</strong>
                <p>모든 권이 대여 중인 경우 "반납알림받기" 버튼이 표시됩니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">3</span>
          ...
          <div class="info-box">
            <h4>💡 반납 알림 참고사항</h4>
            <ul>
              <li>내가 대여 중인 도서에는 반납 알림을 신청할 수 없습니다.</li>
              <li>같은 책이 여러 권인 경우, 내가 그 중 한 권이라도 대여 중이면 알림 신청이 불가합니다.</li>
              <li>"반납 알림 신청됨"으로 표시되면 이미 신청이 완료된 상태입니다.</li>
            </ul>
          </div>
          
          <div class="info-box highlight">
            <h4>📖 이미 읽은 책 대여 시 안내</h4>
            <p>이전에 대여했던 도서를 다시 대여하려고 하면 "이미 읽은 책입니다. 정말로 대여하시겠습니까?" 확인 메시지가 표시됩니다.</p>
          </div>
        </div>
      </section>
      
      <!-- 라벨번호와 위치 안내 -->
      <section id="location" class="guide-section">
        <h2>🏷️ 라벨번호와 위치 안내</h2>
        <div class="section-content">
          <h3>라벨번호란?</h3>
          <p>각 도서에는 고유한 라벨번호가 부여됩니다. 같은 책이 여러 권 있더라도 각각 다른 라벨번호를 가집니다.</p>
          
          <div class="info-box">
            <h4>🏷️ 라벨번호 형식</h4>
            <p><code>카테고리_센터코드+4자리숫자</code></p>
            <ul>
              <li>예시: <code>국내소설_20001</code> (국내소설 카테고리, 용산센터(2), 0001번)</li>
              <li>예시: <code>경제경영_10042</code> (경제경영 카테고리, 강남센터(1), 0042번)</li>
            </ul>
            <p class="small-note">센터코드: 강남센터=1, 용산센터=2 / 뒷 4자리는 일련번호입니다.</p>
          </div>
          
          <h3>위치 정보</h3>
          <p>각 도서는 특정 위치(칸)에 배치되어 있습니다.</p>
          ...
          <ol class="step-list">
            <li>
              <span class="step-number">1</span>
              <div class="step-content">
                <strong>도서 정보에서 위치 아이콘 클릭</strong>
                <p>도서 카드나 대여 확인 화면에서 위치 옆의 <strong>ⓘ 아이콘</strong>을 클릭합니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">2</span>
              <div class="step-content">
                <strong>서가 이미지 확인</strong>
                <p>팝업에서 해당 위치의 서가 이미지를 확인합니다.</p>
              </div>
            </li>
          </ol>
        </div>
        ...
        <div class="section-content">
          ...
          <ol class="step-list">
            ...
            <li>
              ...
              <div class="step-content">
                <strong>도서 검색</strong>
                <p>검색창에 도서명 또는 ISBN-13을 입력하고 검색합니다.</p>
              </div>
            </li>
            <li>
              <span class="step-number">3</span>
      ...
      <section id="mypage" class="guide-section">
        ...
        <div class="section-content">
          ...
          <div class="feature-grid">
            ...
            <div class="feature-card">
              <h4>📋 대여 신청 목록</h4>
              <p>타 센터에 신청한 대여 목록을 확인하고 취소할 수 있습니다.</p>
            </div>
            <div class="feature-card">
              <h4>✋ 내가 신청한 책</h4>
          ...
          <div class="info-box">
            <h4>📋 대여 신청 목록 안내</h4>
            <p>타 센터 도서를 대여 신청한 경우, "대여 신청 목록" 섹션이 표시됩니다.</p>
            <ul>
              <li>본인 근무지와 다른 센터를 선택한 경우에만 표시됩니다.</li>
              <li>신청 대기 중인 도서를 확인하고 취소할 수 있습니다.</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div class="section-content">
          ...
          <ul class="notification-list">
            ...
            <li>
              ...
              <div>
                <strong>반납 알림</strong>
                <p>반납 알림을 신청한 도서가 반납되면 알림을 받습니다.</p>
              </div>
            </li>
          </ul>
          ...
          <h3>이메일 알림</h3>
          <p>알림 페이지에서 "이메일로 알림 받기" 설정을 확인할 수 있습니다.</p>
          <div class="info-box">
            <h4>📧 이메일 알림 기본 설정</h4>
            <p>이메일 알림은 <strong>기본적으로 활성화</strong>되어 있습니다. 원치 않으시면 알림 페이지에서 비활성화할 수 있습니다.</p>
          </div>
        </div>
      </section>
      ...
      <section id="faq" class="guide-section">
        ...
        <div class="section-content">
          <div class="faq-list">
            ...
            <div class="faq-item">
              <h4>Q. 라벨번호는 어디서 확인하나요?</h4>
              <p>A. 대여 시 도서 선택 후 확인 화면에서 라벨번호와 위치를 함께 확인할 수 있습니다.</p>
            </div>
            <div class="faq-item">
              <h4>Q. 같은 책이 여러 권 있을 때 어떤 것을 대여해야 하나요?</h4>
              <p>A. 대여 확인 화면에서 각 권의 위치를 확인하고, 가까운 위치의 도서를 선택하시면 됩니다.</p>
            </div>
            <div class="faq-item">
              <h4>Q. 위치 안내 이미지가 보이지 않아요.</h4>
              <p>A. 도서 정보 옆의 ⓘ 아이콘을 클릭하면 서가 위치 이미지를 확인할 수 있습니다.</p>
            </div>
          </div>
        </div>
      </section>
