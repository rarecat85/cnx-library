    ...
    subsections: [
      {
        ...
        items: [
          ...
          { id: '6.1.8', name: '도서 신청 목록', method: '도서 신청 목록 섹션 확인', expected: '사용자들이 신청한 도서 표시' },
          { id: '6.1.9', name: '신청자 정보 표시', method: '신청 도서 카드 확인', expected: '신청자 근무지, 이름 표시' },
          { id: '6.1.10', name: '신청 도서 등록', method: '신청 도서의 "등록하기" 클릭', expected: '등록 완료, 신청자에게 알림 발송' }
        ]
      },
      {
        title: '6.2 도서 관리',
