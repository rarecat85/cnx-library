    ...
    subsections: [
      {
        ...
        items: [
          ...
          { id: '7.1.2', name: '센터별 카테고리 로드', method: '센터 선택 변경', expected: '해당 센터 카테고리 목록 및 도서 수 표시' },
          { id: '7.1.3', name: '카테고리 추가', method: '점선 "카테고리 추가" 버튼 클릭 후 이름 입력', expected: '새 카테고리가 해당 센터에 추가됨' },
          { id: '7.1.4', name: '카테고리 선택', method: '카테고리 카드 클릭', expected: '선택 상태로 변경 (파란 테두리), 삭제 버튼 표시' },
          { id: '7.1.5', name: '다중 카테고리 선택', method: '여러 카테고리 클릭', expected: '선택된 개수가 삭제 버튼에 표시' },
          { id: '7.1.6', name: '카테고리 삭제 - 도서 없음', method: '도서가 없는 카테고리 선택 후 삭제', expected: '정상 삭제됨' },
          { id: '7.1.7', name: '카테고리 삭제 - 도서 있음', method: '도서가 있는 카테고리 포함하여 삭제 시도', expected: '도서 있는 카테고리는 삭제 실패 메시지' },
          { id: '7.1.8', name: '다중 삭제 부분 성공', method: '일부 도서 있음/없음 혼합 선택 후 삭제', expected: '삭제 성공/실패 상세 결과 표시' }
        ]
      },
      {
        title: '7.2 서가 이미지 관리',
