    ...
    subsections: [
      {
        title: '2.1 라벨번호 형식',
        items: [
          { id: 'v2-2.1.1', name: '라벨번호 자동 생성', method: '도서 등록 시 라벨번호 필드 확인', expected: '카테고리_센터코드+4자리숫자 형식 (예: 소설_YS0001)' },
          { id: 'v2-2.1.2', name: '센터코드 확인', method: '용산센터/강남센터 각각 도서 등록', expected: '용산센터: YS, 강남센터: GN 코드 부여' },
